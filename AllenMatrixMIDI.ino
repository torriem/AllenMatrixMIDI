...
const int midiNoteMap[COLUMN_COUNT][ROW_COUNT] = {
  //keyboard 1
  { 36,  42,  48,  54,  60,  66,  72,  78,  84,  90,  96},  // KB1_IN1
  {  0,  37,  43,  49,  55,  61,  67,  73,  79,  85,  91},  // KB1_IN2
  {  0,  38,  44,  50,  56,  62,  68,  74,  80,  86,  92},  // KB1_IN3
  {  0,  39,  45,  51,  57,  63,  69,  75,  81,  87,  93},  // KB1_IN4
  {  0,  40,  46,  52,  58,  64,  70,  76,  82,  88,  94},  // KB1_IN5
  {  0,  41,  47,  53,  59,  65,  71,  77,  83,  89,  95},  // KB1_IN6
  // keyboard 2
  { 36,  42,  48,  54,  60,  66,  72,  78,  84,  90,  96},  // KB2_IN1
  {  0,  37,  43,  49,  55,  61,  67,  73,  79,  85,  91},  // KB2_IN2
  {  0,  38,  44,  50,  56,  62,  68,  74,  80,  86,  92},  // KB2_IN3
  {  0,  39,  45,  51,  57,  63,  69,  75,  81,  87,  93},  // KB2_IN4
  {  0,  40,  46,  52,  58,  64,  70,  76,  82,  88,  94},  // KB2_IN5
  {  0,  41,  47,  53,  59,  65,  71,  77,  83,  89,  95},  // KB2_IN6
  // pedal board
  { 36,  42,  48,  54,  60,  66,  72,  78,  84,  90,  96},  // PB_IN1
  {  0,  37,  43,  49,  55,  61,  67,  73,  79,  85,  91},  // PB_IN2
  {  0,  38,  44,  50,  56,  62,  68,  74,  80,  86,  92},  // PB_IN3
  {  0,  39,  45,  51,  57,  63,  69,  75,  81,  87,  93},  // PB_IN4
  {  0,  40,  46,  52,  58,  64,  70,  76,  82,  88,  94},  // PB_IN5
  {  0,  41,  47,  53,  59,  65,  71,  77,  83,  89,  95}   // PB_IN6
};
